...
run.par<-function(){
    #sub.dirs<-list.dirs('/data/muscovy/not-backed-up/shu/hapmix/hapmix_trio',recursive=F)
    sub.dirs='/data/muscovy/not-backed-up/shu/hapmix/hapmix_trio'
    fz<-function(xdir){
